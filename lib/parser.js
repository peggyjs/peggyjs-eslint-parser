...
function peg$parse(input, options) {
    ...
    const peg$c27 = function (expression, pipe1, boundaries, delimiter, pipe2) {
    ...
    const peg$c28 = function (min, dots, max) {
        return loc({
            type: "boundaries",
    ...
    const peg$c32 = function (code) {
        return loc({
            type: "function",
            code
        });
    };
    const peg$c33 = function (comma, expression) {
        return loc({
            type: "delimiter",
            comma,
            expression
    ...
    const peg$c39 = function (value) { return loc({ type: "punc", value }); };
    const peg$c40 = peg$otherExpectation("identifier");
    const peg$c41 = function (value) {
        return loc({
            type: "name",
            value,
        });
    ...
    const peg$c53 = function (lit, ignoreCase) {
        return loc({
            type: "literal",
            ...lit,
    ...
    const peg$c55 = function (before, value, after) {
        return {
            ...value,
            before,
            after,
    ...
    const peg$c68 = function (inverted, parts, ignoreCase) {
        return loc({
            type: "class",
    ...
    const peg$c71 = function (begin, end) {
        if (begin.charCodeAt(0) > end.charCodeAt(0)) {
            error("Invalid character range: " + text() + ".");
        }
        return [begin, end];
    };
    const peg$c72 = function () { return ""; };
    const peg$c73 = "0";
    const peg$c74 = peg$literalExpectation("0", false);
    const peg$c75 = function () { return "\0"; };
    const peg$c76 = "x";
    ...
    const peg$c105 = function () { return loc({ type: "any" }); };
    const peg$c106 = peg$otherExpectation("code block");
    const peg$c107 = function (open, bare, close) {
        bare.open = open;
        bare.close = close;
        return bare;
    };
    const peg$c108 = function (value) { return loc({ type: "code", value }); };
    const peg$c109 = /^[{}]/;
    ...
    const peg$c115 = function (digits) { return parseInt(digits, 10); };
    const peg$c116 = function () { return undefined; };
    ...
    const peg$c175 = function (value) { return loc({ type: "punc", value }); };
    const peg$c176 = "/";
