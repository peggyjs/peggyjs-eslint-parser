...
function peg$parse(input, options) {
  ...
  var peg$f4 = function(name, displayName, equals, expression) {
      return loc({
        type: "rule",
        name,
        equals,
  ...
  var peg$f8 = function(pluck, name, expression) {
  ...
  var peg$f9 = function(name, expression) {
      return loc({
        type: "labeled",
        name,
        expression,
  ...
  var peg$f36 = function() { return loc({ type: "any" }); };
  var peg$f37 = function(value) { return loc({ type: "code", value }); };
  var peg$f38 = function() { return loc({
      type: "equals",
    });
  };
  var peg$currPos = 0;
